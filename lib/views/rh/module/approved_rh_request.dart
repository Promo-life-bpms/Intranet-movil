...
class ApprovedRhRequestPage extends StatefulWidget {
  const ApprovedRhRequestPage({Key? key, required this.approvedModel})
      : super(key: key);
  final List<ApprovedRequestModel> approvedModel;

  @override
  State<ApprovedRhRequestPage> createState() => _ApprovedRhRequestState();
}

class _ApprovedRhRequestState extends State<ApprovedRhRequestPage> {
  @override
                          ...
                          child: InkWell(
                            onTap: () {
                              Navigator.of(context).push(MaterialPageRoute(
                                  builder: (context) =>
                                      RequestRhDetail(approvedRequestData: [
