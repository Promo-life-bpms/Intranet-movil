...
import 'package:intranet_movil/views/rh/module/approved_rh_detail.dart';

class PendingRhRequestPage extends StatefulWidget {
  const PendingRhRequestPage({Key? key, required this.approvedModel})
      : super(key: key);
  final List<ApprovedRequestModel> approvedModel;

  @override
  State<PendingRhRequestPage> createState() => _PendingRhRequestState();
}

class _PendingRhRequestState extends State<PendingRhRequestPage> {
  @override
                          ...
                          child: InkWell(
                            onTap: () {
                              Navigator.of(context).push(MaterialPageRoute(
                                  builder: (context) => ApprovedRhRequestDetail(
                                          approvedRequestData: [
                                            ApprovedRequestModel(
                                                id: widget
                                                    .approvedModel[index].id,
                                                employeeID: widget
                                                    .approvedModel[index]
                                                    .employeeID,
                                                fullname: widget
