...
class RejectedRhRequestPage extends StatefulWidget {
  const RejectedRhRequestPage({Key? key, required this.approvedModel})
      : super(key: key);
  final List<ApprovedRequestModel> approvedModel;

  @override
  State<RejectedRhRequestPage> createState() => _RejectedRhRequestState();
}

class _RejectedRhRequestState extends State<RejectedRhRequestPage> {
  @override
