...
class _ManagerRequestPage extends State<ManagerRequestPage> {
  ...
  Stream<List<ApprovedRequestModel>?> _request() async* {
    while (true) {
      ...
      _approvedRequestModel2 = (await ApiManagerRequestService()
              .getManagerRequest(token.toString()))!
            ...
            body: StreamBuilder(
                ...
                builder: (context,
                  ...
                  if (snapshot.hasData) {
                    ...
                    TabBarView(children: [
                      PendingManagerRequestPage(
                          approvedModel: _approvedRequestModel!.reversed
                              .where((element) =>
                                  element.directManagerStatus == "Pendiente")
                              .toList()),
                      ApprovedManagerRequestPage(
                          approvedModel: _approvedRequestModel!.reversed
                              .where((element) =>
                                  element.directManagerStatus == "Aprobada")
                              .toList()),
                      RejectedManagerRequestPage(
                          approvedModel: _approvedRequestModel!.reversed
                              .where((element) =>
