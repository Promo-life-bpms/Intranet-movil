...
class RejectedManagerRequestPage extends StatefulWidget {
  const RejectedManagerRequestPage({Key? key, required this.approvedModel})
      : super(key: key);
  final List<ApprovedRequestModel> approvedModel;

  @override
  State<RejectedManagerRequestPage> createState() =>
      _RejectedManagerRequestState();
}

class _RejectedManagerRequestState extends State<RejectedManagerRequestPage> {
  @override
