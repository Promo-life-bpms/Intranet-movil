...
class StringIntranetConstants {
  ...
  static const publicationPostCommentSuccesful =
  ...
  static const aboutPLDescription =
      "PROMOTIONAL GLOBAL SUPPLIER. Más de una década importando, fabricando y distribuyendo productos promocionales y regalos corporativos para las marcas más prestigiosas. Expertos asesores, socios estratégicos y facilitadores para la adquisición del producto exacto para cada campaña externa o interna de las empresas AAA.";
  static const aboutPLHistory = "Historia";
  static const aboutPLHistoryDescription =
  ...
  static const aboutBHDescription =
      "Más de una década importando, fabricando y distribuyendo productos promocionales y regalos corporativos para las marcas más prestigiosas. Expertos asesores, socios estratégicos y facilitadores para la adquisición del producto exacto para cada campaña externa o interna de las empresas AAA.";

  static const successfulAlertTitle = "¡Solicitud enviada!";
  static const successfulAlertDescription =
      "Tu solicitud ha sido procesada con exito";
  static const wrongAlertTitle =
      "Revisa los datos de tu solicitud e intenta nuevamente";
  static const wrongAlertDescription =
      "Revisa los datos de tu solicitud e intenta nuevamente";
  ...
  static const postMessageError =
      "Mensaje no enviado, revise su conexion a internet ";
}
...
class ListIntranetConstants {
  ...
  final List<AboutData> aboutPL = [
    const AboutData(
        'Lealtad',
        'Es sin duda una de las cualidades más respetables de un ser humano, en especial cuando se trata de una relación de pareja o de una amistad ya que ayuda a mantener un lazo fuerte y generar confianza en el otro.',
        'lib/assets/lealtad.json'),
    const AboutData(
        'Confianza',
        'Nos referimos a la posibilidad  de creer en que otra persona, o un grupo de ellas, actuarán de la manera adecuada en nuestra ausencia, es decir, que no nos defraudarán o nos engañarán, ni necesitan tampoco nuestra supervisión y vigilancia.',
        'lib/assets/confianza.json'),
    const AboutData(
        'Honestidad',
        'Es la virtud humana consistente en el amor a la justicia y la verdad por encima del beneficio personal o de la convivencia',
        'lib/assets/honestidad.json'),
    const AboutData(
        'Trabajo en equipo',
        'Incluye aquellas labores que se realizan de manera compartida y organizada, en las que cada quien asume una parte y todos tienen el mismo objetivo en común. Se trata de una forma de organización del trabajo basada en el compañerismo.',
        'lib/assets/te.json'),
    const AboutData(
        'Productividad',
        'Es un tipo de comportamiento de tipo anticipatorio, que no requiere de un estímulo externo para iniciar una acción o emprender un cambio.',
        'lib/assets/productividad.json')
  ];
}
